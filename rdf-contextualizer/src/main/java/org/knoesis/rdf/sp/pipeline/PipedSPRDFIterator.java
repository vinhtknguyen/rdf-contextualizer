...
public class PipedSPRDFIterator<T> implements Iterator<T>, Closeable {
	    /**
	     ...
	     *            Buffer size
	     */
	    public PipedSPRDFIterator(int bufferSize) {
	     ...
	     */
	    public PipedSPRDFIterator(int bufferSize, boolean fair) {
	     ...
	     *            Max poll attempts
	     */
	    public PipedSPRDFIterator(int bufferSize, boolean fair, int pollTimeout, int maxPolls) {
	        if (pollTimeout <= 0)
